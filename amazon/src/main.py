...
hash = {}
page_number = 1
file_name = "C:/Users/Adarsh Sharma/code/project/ML project/indian-e-commerce-scaper-master/indian-e-commerce-scaper-master/amazon/data.csv" 
...
if does_file_exists:
    with open(file_name, "r") as file:
        ...
        for item in existing_items:
            if len(item) < 2:
                    print_red("Skipping an invalid or empty row in the CSV file.")
                    continue
            title, image, *_ = item 
